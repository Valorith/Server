	...
	switch (in->method) {
		case BazaarByVendor: {
			if (
				...
				LogTrading(
					"Unable to resolve in-zone trader for vendor purchase item_unique_id <red>[{}] requested trader_id <red>[{}] resolved character_id <red>[{}] zone <red>[{}] instance <red>[{}] entity <red>[{}] buyer zone <red>[{}] instance <red>[{}]",
					in->item_unique_id,
					in->trader_id,
